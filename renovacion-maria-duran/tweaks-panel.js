...
// tweaks-panel.js — compiled from tweaks-panel.jsx
...
function TweakSlider({ label, value, min = 0, max = 100, step = 1, unit = '', onChange }) {
  return React.createElement(TweakRow, { label, value: `${value}${unit}` },
    React.createElement('input', {
      type: 'range', className: 'twk-slider', min, max, step,
...
function TweakRadio({ label, value, options, onChange }) {
  ...
  return React.createElement(TweakRow, { label },
    React.createElement('div', {
      ref: trackRef, role: 'radiogroup', onPointerDown,
...
function TweakSelect({ label, value, options, onChange }) {
  return React.createElement(TweakRow, { label },
    React.createElement('select', {
      className: 'twk-field', value, onChange: (e) => onChange(e.target.value)
    }, options.map((o) => {
...
function TweakText({ label, value, placeholder, onChange }) {
  return React.createElement(TweakRow, { label },
    React.createElement('input', {
      className: 'twk-field', type: 'text', value, placeholder,
...
function TweakColor({ label, value, onChange }) {
  return React.createElement('div', { className: 'twk-row twk-row-h' },
    React.createElement('div', { className: 'twk-lbl' }, React.createElement('span', null, label)),
    React.createElement('input', {
      type: 'color', className: 'twk-swatch', value,
      onChange: (e) => onChange(e.target.value)
    })
  );
}
